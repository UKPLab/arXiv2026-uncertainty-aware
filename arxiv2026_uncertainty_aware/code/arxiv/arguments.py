...
class ModelArguments:
    ...
    possible_scores: str = field(default=None)
    possible_quality_scores: str = field(default=None)
    possible_acts: str = field(default=None)
    dropout: float = field(default=0.1)


    manual_seed: int = field(default=42)

    use_probs_for_eval: bool = field(default=False)
...
class DataPredictionArguments:
    ...
    reviews_file: Optional[str] = field(default=None)
    scores_file: Optional[str] = field(default=None)
    consistency_file: Optional[str] = field(default=None)
    quality_file: Optional[str] = field(default=None)
    mbr_file: Optional[str] = field(default=None)
    threshold_file: Optional[str] = field(default=None)
    
@dataclass
class OptimizerArguments:
    optimizer_name: Optional[str] = field(default="AdamW")
    optimizer_state: Optional[str] = field(default=None)
    ...
    train_shuffle: bool = field(default=True)
